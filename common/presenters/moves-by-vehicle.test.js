      ...
      describe('grouping', function () {
        ...
        describe('headers', function () {
          ...
          it('should set people header', function () {
            expect(
              output.every(group => group.header[1].label === 'people')
            ).to.be.true

            expect(
              output.every(
                group =>
                  group.header[1].classes === 'govuk-grid-column-one-quarter'
              )
            ).to.be.true
          ...
          it('should set expected time header', function () {
            expect(
              output.every(
                group =>
                  group.header[2].label === 'collections::labels.expected_time'
              )
            ).to.be.true
            ...
            expect(
              output.every(
                group =>
                  group.header[2].classes === 'govuk-grid-column-one-half'
              )
            ).to.be.true
