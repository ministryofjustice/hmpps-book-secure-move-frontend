...
// This is a map of estimated test run times, used to balance the e2e processes. They were generated by running each file individually 3 times and using the average run time.
const testWeights = {
  '#smoke': 73.4,
  'allocation/assign': 40.3,
  'allocation/cancel': 31.3,
  'allocation/new': 22.6,
  'allocation/remove-move': 19.6,
  'date-select': 19.6,
  'move/dashboard': 22.4,
  'move/download': 39.2,
  'move/new/police/to-court': 64.7,
  'move/new/police/to-prison-recall': 35.7,
  'move/new/prison/to-court': 25.4,
  'move/new/prison/to-prison': 37.4,
  'move/new/stc/to-court': 23.7,
  'move/new/stc/to-hospital': 24.4,
  'move/new/stc/to-prison': 23,
  'move/new/stc/to-sch': 22.7,
  'move/outgoing/multiple': 13,
  'move/timeline': 11.4,
  'move/update/forbidden': 15,
  'move/update/police/existing': 22.7,
  'move/update/police/to-court': 66.7,
  'move/update/police/to-prison-recall': 11.7,
  'move/update/sch/existing': 19.4,
  'move/update/sch/to-court': 15.7,
  'move/update/sch/to-hospital': 13.7,
  'move/update/sch/to-prison': 10.4,
  'move/update/sch/to-sch': 10.7,
  'move/update/sch/to-stc': 10.4,
  'move/update/stc/existing': 20.4,
  'move/update/stc/to-court': 18,
  'move/update/stc/to-hospital': 13,
  'move/update/stc/to-prison': 10.4,
  'move/update/stc/to-sch': 13,
  'move/update/stc/to-stc': 10.7,
  'person-escort-record/new': 42.7,
  'population/dashboard': 12,
  'population/edit': 12.4,
}
...
const testsWithWeights = tests
  .map(test => {
    const weight = testWeights[test.substr(9, test.length - 17)] || 0
